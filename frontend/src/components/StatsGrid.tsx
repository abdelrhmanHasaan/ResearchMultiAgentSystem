    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
      ...
      >
        ...
        <div className="flex items-center justify-between relative z-10">
          <div>
            <p className="text-[10px] font-mono text-slate-400 tracking-wider uppercase">Sources Indexed</p>
            <h3 className="text-2xl font-bold text-white mt-1 tracking-tight font-mono">
              {loading ? (
                ...
                formatNumber(stats.total_pages)
              )}
            </h3>
      ...
      >
        ...
        <div className="flex items-center justify-between relative z-10">
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-medium mt-0.5">Vector embeddings stored</p>
          </div>
      ...
      >
        ...
        <div className="flex items-center justify-between relative z-10">
          <div>
            <p className="text-[10px] font-mono text-slate-400 tracking-wider uppercase">Avg Chunks / Page</p>
            <h3 className="text-2xl font-bold text-white mt-1 tracking-tight font-mono">
              {loading ? (
                <span className="inline-block w-12 h-6 bg-slate-800 animate-pulse rounded"></span>
              ) : (
                (stats.avg_chunks_per_page ?? 0).toFixed(1)
              )}
            </h3>
            <p className="text-[10px] text-emerald-400 font-medium mt-0.5">Index density metric</p>
          </div>
